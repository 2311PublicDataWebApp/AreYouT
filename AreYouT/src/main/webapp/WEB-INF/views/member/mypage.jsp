				...
				<ul style="list-style-type: none; padding-left: 0;">
					...
					<li>
						<div class="form-floating">
							<div class="box"
							style="padding: 15px 0 0 6px; height: 57px; border: 1px solid #DCE2E3; border-radius: 5px;">
								<label for="memberEmail"></label> <span>${member.memberEmail }</span>
							</div>
						</div>
					</li>
					<br>
					...
					<li>
						<div class="form-floating">
							<div class="box"
								style="padding: 15px 0 0 6px; height: 57px; border: 1px solid #DCE2E3; border-radius: 5px;">
								<label for="memberPhone"></label> <span>${member.memberPhone }</span>
							</div>
						</div>
					</li>
				</ul>
				</fieldset>
				<input type="button" onclick="location.href='/member/update.kh' "  style="width:475px; font-size: larger; margin-top:30px; color:white; background-color: #5AD897; height: 45px; border: 1px solid #DCE2E3; border-radius: 8px;" value="수정하기">
				<button class="w-100 btn btn-lg btn-primary" type="button"
					style="margin-top: 30px; background-color: #5AD897; border: 0px;" onclick="location.href='/member/deletecheck.kh'">회원탈퇴</button>
