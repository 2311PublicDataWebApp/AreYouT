            ...
            <div class="row">
                <div class="col-md-2" id="menu-container">
                    ...
                    <ul class="list-unstyled">
                        <li class="menu-item"><a href="/manager/main.kh">대쉬보드</a></li>
                        <br><br><br>
                ...
                <div class="container mt-3" id="member-manager">
                    ...
                    <div class="input-group mr-sm-2">
                        <div class="form-inline">
                        	<form class="form-inline" id="search" action="/manager/member/search.kh" method="GET">
                            ...
                            <div class="ml-auto form-inline">
                                <form action="/manager/member/black.kh" method="post">
                                ...
                                &nbsp;
                             	<form action="/manager/member/delete.kh" method="post">
                        ...
                        <br>
                        <form action="/manager/member/search.kh" id="member-list" method="get">
                            <div id="board-list">
											...
											<tr align="center">
												<td colspan="5">
													<c:if test="${pInfo.startNavi ne '1'}">
														<a href="/manager/member/search.kh?page=${pInfo.startNavi - 1}&search-type=${pInfo.searchType}&search-keyword=${pInfo.searchKeyword}">[이전]</a>
													</c:if>
													<c:forEach begin="${pInfo.startNavi}" end="${pInfo.endNavi}" var="p">
							               				<a href="/manager/member/search.kh?page=${p}&search-type=${pInfo.searchType}&search-keyword=${pInfo.searchKeyword}">${p}</a>
							            			</c:forEach>
							            			<c:if test="${pInfo.endNavi ne pInfo.naviTotalCount}">
														<a href="/manager/member/search.kh?page=${pInfo.endNavi + 1}&search-type=${pInfo.searchType}&search-keyword=${pInfo.searchKeyword}">[다음]</a>
													</c:if>
												</td>
											</tr>
										</tfoot>
