            ...
            <div class="row">
                ...
                <div class="container mt-3" id="member-manager">
                    ...
                    <hr>
                        ...
                        <br>
                        <form action="/manager/message/search.kh" id="member-list" method="get">
                            <div id="board-list">
                                    ...
                                    <table class="board-table">
                                        ...
                                        <tfoot>
                                        	...
                                        	<c:if test="${pInfo.startNavi ne '1'}">
												<a href="/manager/message/search.kh?page=${pInfo.startNavi - 1}&search-type=${pInfo.searchType}&search-keyword=${pInfo.searchKeyword}">[이전]</a>
											</c:if>
											<c:forEach begin="${pInfo.startNavi}" end="${pInfo.endNavi}" var="p">
							               		<a href="/manager/message/search.kh?page=${p}&search-type=${pInfo.searchType}&search-keyword=${pInfo.searchKeyword}">${p}</a>
							            	</c:forEach>
							            	<c:if test="${pInfo.endNavi ne pInfo.naviTotalCount}">
												<a href="/manager/message/search.kh?page=${pInfo.endNavi + 1}&search-type=${pInfo.searchType}&search-keyword=${pInfo.searchKeyword}">[다음]</a>
                                        	</c:if>
                                        		</td>
                                        	</tr>
                                        </tfoot>
