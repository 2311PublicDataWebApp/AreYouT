...
<!-- 			</section> -->
			...
			<footer id="footer">
				<div class="foot">
					<img src="../resources/img/back.PNG" style="width: 2000px; height: 500px; margin-left: -500px;" />
					<button type="button" class="btn btn-primary" onclick="history.back()" style="margin-left: 400px; margin-top: 50px;">내 Mbti결과 보러가기</button>
					<p class="author">
					</p>
				</div>
			</footer>
