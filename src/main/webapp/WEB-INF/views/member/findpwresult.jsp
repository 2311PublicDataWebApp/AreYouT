  ...
  <symbol id="grid" viewBox="0 0 16 16">
	...
	<main>
		...
		<div class="container"
			style="width: 500px; margin-top: 100px; margin-bottom: 100px;">
			<main class="form-signin w-100 m-auto">
				<form action="/member/updatepw.kh" method="post" id="frm">
					<fieldset>
						<input type="hidden" name="memberId" id="memberId"
							value="${member.memberId }"> <input type="hidden"
							name="memberEmail" id="memberEmail"
							value="${member.memberEmail }"> <img class="mb-4"
						...
						<input type="button" value="비밀번호 재설정" onclick="checkValueAndSubmit()" style="width:475px; font-size: larger; margin-top:30px; color:white; background-color: #5AD897; height: 45px; border: 1px solid #DCE2E3; border-radius: 8px;">
