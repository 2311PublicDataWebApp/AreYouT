  ...
  <symbol id="grid" viewBox="0 0 16 16">
	...
	<main>
		...
		<div class="container"
			...
			<main class="form-signin w-100 m-auto">
				<%-- <fieldset>
					<legend>아이디 찾기 페이지</legend>
					<ul>
						<li><label for="memberId">아이디</label> <span>${member.memberId }</span>
						</li>
					</ul>
				</fieldset>
				<br> <a href="/index.jsp">메인으로 이동</a> --%>




				<form action="/member/findidresult.kh" method="post">
					<fieldset>
							...
							<li>
								<div class="form-floating">
									<!-- <input type="text" class="form-control" name="memberId"
										...
										<div class="idbox" style="padding: 15px 0 0 6px; height: 57px; border: 1px solid #DCE2E3; border-radius: 5px;">										
									<label for="memberId"></label> <span>${member.memberId }</span>
										</div>
									<!--  <label -->
									<%-- 										for="floatingInput"><span>${member.memberId }</span></label> --%>
								</div>
							</li>
						</ul>
					</fieldset>
						...
						<button class="w-100 btn btn-lg btn-primary" onclick="location.href='/member/login.kh' "
							style="margin-top: 30px; background-color: #5AD897; border: 0px;">로그인</button>
						<button class="w-100 btn btn-lg btn-primary" onclick="location.href='/member/findpw.kh' "
							style="margin-top: 30px; background-color: #5AD897; border: 0px;">비밀번호
							찾기</button>
