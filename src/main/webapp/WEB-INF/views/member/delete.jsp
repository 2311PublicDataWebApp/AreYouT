  ...
  <symbol id="grid" viewBox="0 0 16 16">
			...
			<main class="form-signin w-100 m-auto">
				<form action="/member/delete.kh" method="post">
					...
					<fieldset>
						...
						&nbsp회원 탈퇴 시 모든 개인정보가 즉시 파기됩니다.
							<li>
								<!-- 							<label for="memberPw">비밀번호</label> --> <!-- 							<input -->
								<!-- 								type="password" name="memberPw" id="memberPw" --> <!-- 								placeholder="비밀번호 입력"> -->
						...
						<button class="w-100 btn btn-lg btn-primary" type="submit" id="delete"
							style="margin-top: 30px; background-color: #5AD897; border: 0px;">회원탈퇴</button>
    ...
    <script>
      document.getElementById("delete").onclick = function () {
    	  ...
    	  if (confirm("회원 탈퇴 시 모든 개인정보가 즉시 파기됩니다. 탈퇴하시겠습니까?") == false ){
    		  return false;
    	}
    };
    </script>
