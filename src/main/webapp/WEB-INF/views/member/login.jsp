						...
						<div class="dropdown text-end">
							<a href="#"
								...
								data-bs-toggle="dropdown" aria-expanded="false"> <c:if
									...
									<img id="profilesmall"
										src="../resources/muploadFiles/${member.memberFilename }"
		...
		<div class="container"
			...
			<main class="form-signin w-100 m-auto">
				<form action="/member/login.kh" method="post">
					...
					<div id="loginUnder" class="checkbox mb-3" style="margin-top:5px;">
						<label> 
							<a href="/member/findid.kh" style="margin-left:5px;">아이디 찾기</a>
							<a href="/member/findpw.kh">비밀번호 찾기</a>
							<a href="/member/register.kh" style="margin-left:245px;">회원가입</a>
						</label>
					</div>
