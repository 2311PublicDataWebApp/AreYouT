	...
	<main>
		...
		<div class="container"
			...
			<main class="form-signin w-100 m-auto">
				<form action="/member/updateprofile.kh" method="post" enctype="multipart/form-data">
					<fieldset>
						<input type="hidden" name="memberFilename" 	 value="${member.memberFilename }">
						<input type="hidden" name="memberFileRename" value="${member.memberFileRename }">
						<input type="hidden" name="memberFilePath" 	 value="${member.memberFilePath }">
						<input type="hidden" name="memberFileLength" value="${member.memberFileLength }">
						<input type="hidden" name="memberId" id="memberId" value="${member.memberId }"> 
						<img class="mb-4"
							src="/resources/img/LOGO1.png" width="80" height="80" role="img"
							class="footerLogo">
						<h1 class="h3 mb-3 fw-normal">프로필 수정</h1>
						<ul style="list-style-type: none; padding-left: 0;">
							<li>
							<label>프로필 사진</label> <br>
							<input type="file" name="uploadFile" style="margin:10px 0 30px;">
							</li>
							닉네임
							<li><label for="memberNickname"></label> 
							<input type="text" placeholder="2~10글자 닉네임 입력" name="memberNickname" id="memberNickname" value="${member.memberNickname }"
								style="width: 475px; padding: 0 0 0 10px; margin: 0 0 0 -5px; height: 57px; border: 1px solid #DCE2E3; border-radius: 5px;">
							</li>
							<br> 나이
							<li>
								<div class="form-floating">
									<div class="box"
										...
										<label for="memberAge"></label> <span>${member.memberAge }</span>
									</div>
								</div>
							</li>
							<br> 성별
							<li>
								<div class="form-floating">
									<div class="box"
										style="padding: 15px 0 0 6px; height: 57px; border: 1px solid #DCE2E3; border-radius: 5px;">
										<label for="memberGender"></label> <span>${member.memberGender }</span>
									</div>
								</div>
							</li>
							<br> MBTI
						...
						<input type="submit" value="프로필 수정" style="width:475px; font-size: larger; margin-top:30px; color:white; background-color: #5AD897; height: 45px; border: 1px solid #DCE2E3; border-radius: 8px;">
						<!-- <button class="w-100 btn btn-lg btn-primary" type="submit"
							style="margin-top: 30px; background-color: #5AD897; border: 0px;">프로필
							수정</button> -->
					</fieldset>
				</form>
