		...
		<div class="container"
			...
			<main class="form-signin w-100 m-auto">
				<fieldset>
					...
					<h1 class="h3 mb-3 fw-normal">프로필</h1>
					<ul style="list-style-type: none; padding-left: 0;">

						<li><label>프로필 사진</label><br>
						<c:if
								test="${member.memberFilename eq null }">
								<img src="../resources/muploadFiles/basic.png"
									style="border: 1px solid #DCE2E3; width: 250px; height: 250px; margin-bottom: 30px;">
							</c:if> 
							<c:if test="${member.memberFilename ne null }">
								<img src="../resources/muploadFiles/${member.memberFileRename }"
									style="border: 1px solid #DCE2E3; width: 250px; height: 250px; margin-bottom: 30px;">
							</c:if> 
							<%-- 				
							<span>
						...
						<li>
							<div class="form-floating">
								<div class="box"
									...
									<label for="memberNickname"></label> <span>${member.memberNickname }</span>
								</div>
							</div>
						</li>
						<br> 나이
				...
				<button class="w-100 btn btn-lg btn-primary"
					onclick="location.href='/member/updateprofile.kh' "
					style="margin-top: 30px; background-color: #5AD897; border: 0px;">수정하기</button>
