	...
	<main>
		...
		<div class="container"
			...
			<main class="form-signin w-100 m-auto">
				<form action="/member/update.kh" method="post" id="frm">
					<fieldset>
						<input type="hidden" name="memberId" id="memberId"
							value="${member.memberId }"> <img class="mb-4"
							src="/resources/img/LOGO1.png" width="80" height="80" role="img"
							class="footerLogo">
						<h1 class="h3 mb-3 fw-normal">내정보 수정</h1>
						<ul style="list-style-type: none; padding-left: 0;">
							...
							<li>
								<div class="form-floating">
									<div class="box"
										...
										<label for="memberId"></label> <span>${member.memberId }</span>
									</div>
								</div>
							</li>
							<br>
							...
							<li>
							 <label
										for="memberPw"></label>
							<input type="password" name="memberPw" placeholder="6~20자리 영문자, 숫자 입력"
										id="memberPw" value="${member.memberPw }" style="width: 475px; padding:0 0 0 10px; margin: 0 0 0 -5px; height: 57px; border: 1px solid #DCE2E3; border-radius: 5px;">
							</li>
							<br>
							이름
							<li>
								<div class="form-floating">
									<div class="box"
										style="padding: 15px 0 0 6px; height: 57px; border: 1px solid #DCE2E3; border-radius: 5px;">
										<label for="memberName"></label> <span>${member.memberName }</span>
									</div>
								</div>
							</li>
							<br>
							...
							<li>
							 <label
										for="memberEmail"></label>
							<input type="text" name="memberEmail" placeholder="도메인 포함하여 이메일 입력"
										id="memberEmail" value="${member.memberEmail }" style="width: 475px; padding:0 0 0 10px; margin: 0 0 0 -5px; height: 57px; border: 1px solid #DCE2E3; border-radius: 5px;">
							</li>
							<br>
							전화번호
							<li>
							 <label
										for="memberPhone"></label>
							<input type="text" name="memberPhone" placeholder="- 포함하여 전화번호 입력"
										id="memberPhone" value="${member.memberPhone }" style="width: 475px; padding:0 0 0 10px; margin: 0 0 0 -5px; height: 57px; border: 1px solid #DCE2E3; border-radius: 5px;">
							</li>
						</ul>
						<input type="button" value="내정보 수정" onclick="checkValueAndSubmit()" style="width:475px; font-size: larger; margin-top:30px; color:white; background-color: #5AD897; height: 45px; border: 1px solid #DCE2E3; border-radius: 8px;">
						<!-- <button class="w-100 btn btn-lg btn-primary" type="submit"
							style="margin-top: 30px; background-color: #5AD897; border: 0px;">내정보 수정</button> -->
					</fieldset>
				</form>
