  ...
  <div class="album py-5 bg-body-tertiary">
    <div class="container">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <c:forEach items="${sList}" var="notice" varStatus="i" begin="0" end="8">
                <div class="col d-flex flex-column h-100">
                    <div class="card shadow-sm">
							...
							<c:if test="${not empty notice.noticeFileRename}">
							    <!-- DB에 저장된 파일이 있는 경우 -->
							    <img id="profilesmall" src="../resources/nuploadFiles/${notice.noticeFileRename}" width="100%" height="225" alt="Profile Image">
                        ...
                        <form class="row g-1" action="/notice/search.kh" method="get">
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    <input class="form-control" type="search" name="searchKeyword" placeholder="검색어를 입력해주세요." value="${searchKeyword }">
                         ...
                         <ul class="pagination justify-content-center" style="font-weight: 600; ">
                             <c:if test="${pInfo.startNavi != 1 }">
                                 <li class="page-item">
                                     ...
                                     <a class="page-link rounded-circle" href="/notice/search.kh?page=${pInfo.startNavi - 1 }&searchCondition=${searchCondition}&searchKeyword=${searchKeyword}" aria-label="Previous">
                             ...
                             <c:forEach begin="${pInfo.startNavi }" end="${pInfo.endNavi }" var="p">
                                 <li class="page-item">
                                     <a class="page-link rounded-circle mx-2" href="/notice/search.kh?page=${p }&searchCondition=${searchCondition}&searchKeyword=${searchKeyword}" style="border: none; color: #313131;">
                                         ${p }
                                     </a>
                                 </li>
                             </c:forEach>
                             <c:if test="${pInfo.endNavi != pInfo.naviTotalCount }">
                                 <li class="page-item">
                                     <a class="page-link rounded-circle" href="/notice/search.kh?page=${pInfo.endNavi + 1 }&searchCondition=${searchCondition}&searchKeyword=${searchKeyword}" aria-label="Next">
