            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <article style="margin-left: 150px;">
                        ...
                        <header class="mb-4">
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1">${notice.noticeSubject }</h1>
<!--                             Post meta content -->
...
<%--                         <figure class="mb-4"><img class="img-fluid rounded" src="../resources/nuploadFiles/${notice.noticeFileRename }" style="width:800px; height: 400px;" /></figure> --%>
<%--                         src="../resources/nuploadFiles/${notice.noticeFileRename }" --%>
                      <c:if test="${empty notice.noticeFileRename}">
						    <!-- DB에 저장된 파일이 없는 경우 -->
						    <img id="profilesmall" src="../resources/nuploadFiles/sea.jpg" width="800px" height="400px" class="square" style="margin-bottom: 30px;">
						</c:if>
						<c:if test="${not empty notice.noticeFileRename}">
						    <!-- DB에 저장된 파일이 있는 경우 -->
						    <img id="profilesmall" src="../resources/nuploadFiles/${notice.noticeFileRename}" width="800px" height="400px">
						</c:if>
						
                        <!-- Post content-->
                        <section class="mb-5">
                            <p class="fs-5 mb-4">${notice.noticeContent }</p>
                            <p class="fs-5 mb-4">${notice.noticeWriter } &nbsp;</p>
                            <br><br><br>
                            <button type="button" class="btn btn-sm btn-outline-secondary"><a href="/message/list.kh" style="text-decoration: none;">쪽지하기</a></button>
                        </section>
